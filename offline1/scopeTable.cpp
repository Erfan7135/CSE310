...
bool scopeTable::Insert(symbolInfo *s){
    ...
    if(table[bucket_no]==NULL){
        table[bucket_no]=s;
        cout<<"Inserted in ScopeTable# "<<id<<" at position "<<bucket_no<<", "<< 0<<"\n\n"<<endl;
        return true;
    }
    else{
        int p=0;
        ...
        prev=NULL;
        while(a!=NULL ){
            if(a->getName().compare(s->getName())==0){
                //Already Exist
                cout<<"<"<<s->getName()<<","<<s->getType()<<"> ";
                cout<<"Already exist in current Scope Table\n\n"<<endl;
                return false;
            }
            prev=a;
            a=a->getNext();
        ...
        prev->setNext(s);
        cout<<"Inserted in ScopeTable# "<<id<<" at position "<<bucket_no<<", "<< p<<"\n\n"<<endl;
        return true;
    }
}
    ...
    if(table[bucket_no]==NULL){
        ...
        while(a!=NULL ){
            if(a->getName().compare(str)==0){
                //Found
                cout<<"Found in ScopeTable# "<<id<<" at position "<<bucket_no<<", "<< p<<"\n\n"<<endl;
                return a;
            }
            p++;
            a=a->getNext();
    ...
    if(table[bucket_no]==NULL){
        ...
        while(a!=NULL ){
            if(a->getName().compare(str)==0){
                ...
                cout<<"Found in ScopeTable# "<<id<<" at position "<<bucket_no<<", "<< p<<"\n";
                cout<<"Deleted entry at "<<bucket_no<<","<<p<<" in the current scopetable\n\n";
                return true;
            }
            p++;
            b=a;
